...
export default function ComparePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 selection:bg-indigo-100">
      ...
      {/* ── Responsive container: 16px padding on tiny phones, grows to 48px on wide screens */}
      <div className="w-full px-4 py-5 sm:px-6 sm:py-7 md:px-8 md:py-8 lg:px-12 lg:py-10 xl:px-16">
        <div className="mx-auto max-w-7xl space-y-6 sm:space-y-8 lg:space-y-10 animate-in fade-in duration-500">
