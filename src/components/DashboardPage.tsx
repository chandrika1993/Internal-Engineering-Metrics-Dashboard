...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] px-4 md:px-6 lg:px-12 py-8 lg:py-10 selection:bg-indigo-100">
      <div className="mx-auto max-w-7xl space-y-8 md:space-y-12 animate-in fade-in duration-500">
        {/* ─── HEADER ─── */}
